...
for (var i = 0; i < computers.length; i++) {
    ...
    if (computer.ram < 16) {
        allComputersCanRunProgram = false; // here we flip that var to false 
        // currently we assume all our computers can run that program
    } else {
        onlySomeComputersCanRunProgram = true;
    }
}
var computersCanRunProgram;
var onlySomeComputersCanRunProgram;
